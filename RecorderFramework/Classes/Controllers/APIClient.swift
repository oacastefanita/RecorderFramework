...
open class Api: NSObject {
    ...
    open func doRequest(_ url:String, method:HTTPMethod, interestedInFields:[String : Any]!, parameters:[String : Any]!, storeAuthRequest:Bool = false, completionHandler:((Bool, [String : Any]?) -> Void)?) {
